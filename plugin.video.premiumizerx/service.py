...
control.execute('RunPlugin(plugin://plugin.video.premiumizerx/?action=service)')	
...
# class Service():
    ...
    # def ServiceEntryPoint(self):
        ...
        # while not monitor.abortRequested():
            ...
            # control.execute('RunPlugin(plugin://plugin.video.premiumizerx/?action=transferMonitor)')
